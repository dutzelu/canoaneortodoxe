...
<form autocomplete="off" action="/action_page.php">
  <div class="autocomplete" style="width:300px;">
    <input id="autocomplete" type="text" name="cuvinte" placeholder="Country">
  </div>
  <input type="submit">
</form>
...
/*initiate the autocomplete function on the "autocomplete" element, and pass along the cuvinteCheie array as possible autocomplete values:*/
