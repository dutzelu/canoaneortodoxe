...
if (isset($_GET['id'])) {
        ...
        while ($data = mysqli_fetch_assoc($rezultate2)){    
            ...
            while ($data2 = mysqli_fetch_assoc($sql_cap_rez)){    
                ...
                echo '<p><span class="badge badge-secondary">'.$data['Nume'] .' </span>' . ' <a style="color:red; text-align:"right"  href="' .  BASE_URL . 'unic.php/' . $url . '">[View] </a></p>' ; 
        ...
        ?>
                ...
                <form action="<?php echo BASE_URL;?>admin/update.php?id=<?php echo $b;?>" method="POST">
